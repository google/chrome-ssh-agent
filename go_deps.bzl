...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:dau3hWo52ZKpGSn0M9hcI5kNdS+SHuAl6IBEGyJ1eI4=",
        version = "v0.2.1-0.20210910170740-6b2ef24cfe95",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:osPk40NN+GLEj2Tay/N+H/K4itKyHZ6gdrC/pXjjgQ8=",
        version = "v0.0.0-20200209033844-7e00b02ea7d2",
    )
    ...
    go_repository(
        ...
        sum = "h1:g+tXxqDUtiQw6sM7/DJx/O43+lMe1mbYq5od6klloWM=",
        version = "v1.17.3-0.20220613211448-f2ebe4653ade",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_mediabuyerbot_go_crx3",
        importpath = "github.com/mediabuyerbot/go-crx3",
        sum = "h1:JG3Hlaf7FsMhTJHBt+iEO5bK1GTh/Ms/cBT2aR2kBUE=",
        version = "v1.3.1",
    )
    go_repository(
